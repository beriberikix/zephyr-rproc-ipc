...
MEMORY
    ...
    ITCM ( rw ) : ORIGIN = (0), LENGTH = (262144) vdev0vring0 ( rw ) : ORIGIN = (2281701376), LENGTH = (32768) vdev0vring1 ( rw ) : ORIGIN = (2281734144), LENGTH = (32768) vdevbuffer ( rw ) : ORIGIN = (2281832448), LENGTH = (1048576) rsc_table ( rw ) : ORIGIN = (2283929600), LENGTH = (4096)
...
scmi_protocol_area : ALIGN_WITH_INPUT { _scmi_protocol_list_start = .; KEEP(*(SORT_BY_NAME(._scmi_protocol.static.*))); _scmi_protocol_list_end = .;; } > RAM AT > FLASH
...
.intList :
{
 ...
 KEEP(*(.gnu.attributes))
    ...
    ITCM (NOLOAD) : { __ITCM_start = .; KEEP(*(ITCM)) KEEP(*(ITCM.*)) __ITCM_end = .; } > ITCM __ITCM_size = __ITCM_end - __ITCM_start; __ITCM_load_start = LOADADDR(ITCM); vdev0vring0 (NOLOAD) : { __vdev0vring0_start = .; KEEP(*(vdev0vring0)) KEEP(*(vdev0vring0.*)) __vdev0vring0_end = .; } > vdev0vring0 __vdev0vring0_size = __vdev0vring0_end - __vdev0vring0_start; __vdev0vring0_load_start = LOADADDR(vdev0vring0); vdev0vring1 (NOLOAD) : { __vdev0vring1_start = .; KEEP(*(vdev0vring1)) KEEP(*(vdev0vring1.*)) __vdev0vring1_end = .; } > vdev0vring1 __vdev0vring1_size = __vdev0vring1_end - __vdev0vring1_start; __vdev0vring1_load_start = LOADADDR(vdev0vring1); vdevbuffer (NOLOAD) : { __vdevbuffer_start = .; KEEP(*(vdevbuffer)) KEEP(*(vdevbuffer.*)) __vdevbuffer_end = .; } > vdevbuffer __vdevbuffer_size = __vdevbuffer_end - __vdevbuffer_start; __vdevbuffer_load_start = LOADADDR(vdevbuffer); rsc_table (NOLOAD) : { __rsc_table_start = .; KEEP(*(rsc_table)) KEEP(*(rsc_table.*)) __rsc_table_end = .; } > rsc_table __rsc_table_size = __rsc_table_end - __rsc_table_start; __rsc_table_load_start = LOADADDR(rsc_table);
.last_section :
{
  KEEP(*(.last_section))
} > FLASH
